...
function counter() {	
  ...
  if (count === 1) {
    ...
    let arr = ['<input type="radio" name="q5answBtns" value="<%=quiz.question5RA%>"><label for="question5RA" id="question5RA"><%=quiz.question5RA%></label><br>','<input type="radio" name="q5answBtns" value="<%=quiz.question5FA1%>"><label for="question5FA1" id="question5FA1"><%=quiz.question5FA1%></label><br>','<input type="radio" name="q5answBtns" value="<%=quiz.question5FA2%>"><label for="question5FA2" id="question5FA2"><%=quiz.question5FA1%></label><br>',' <input type="radio" name="q5answBtns" value="<%=quiz.question5FA3%>"><label for="question5FA3" id="question5FA3"><%=quiz.question5FA3%></label><br>'];
    document.getElementById("nameinput").style.display = "none"
